...
function stringHoursMinutes(timeString) {
  ...
  const hours = parseInt(timeString.slice(0, seperatorPosition));
  const minutes = parseInt(timeString.slice(seperatorPosition + 1));
...
console.log(scheduleMeeting("07:00", 30));
